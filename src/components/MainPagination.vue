...
<div class="flex justify-center gap-4 p-8">
    ...
    <button v-for="page in pages" :key="page" class="rounded-md bg-slate-100 p-2 font-medium text-slate-700 shadow-md" :class="page == activePage ? 'bg-blue-700 text-slate-100': '' "> {{ page }}</button>
